...
var idade int = 27
var peso float64 = 80
var pesopizza float64 = 1 // <<<<<<<------- a variável pesopizza deveria ser do tipo int. Confere lá em cima no texto.

func main() {

	var total = peso + pesopizza // <<<<<<<------- A variável pesopizza deveria ser do tipo int. Logo, como ficaria essa soma?
